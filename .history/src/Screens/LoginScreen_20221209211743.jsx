...
function LoginScreen(props) {
  console.log(props)
  return (
    <div className=" h-screen overflow-x-hidden bg-white grid grid-col-1 lg:grid-cols-2 xl:grid-cols-5">
      <div className="">
        ...
        <div className=" pt-10">
            ...
            <div className=" flex space-x-3">
                <button onClick={()=>} className=" flex items-center space-x-1 px-4 border py-[6px] w-1/2 justify-center rounded-md">
      ...
      <div className="hidden  lg:flex xl:col-span-4">
