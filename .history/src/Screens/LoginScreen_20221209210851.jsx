...
function LoginScreen() {
  return (
    <div className=" h-screen grid grid-col-1 lg:grid-cols-2 xl:grid-cols-5">
      <div className=" overflow-y-scroll">
        <div className=" px-10 pt-4">
        <div className=" flex items-center pt-1">
          <img className=" h-14 w-14" src="" alt="LOGO of Site" />
          <p className=" text-2xl font-medium text-gray-800 ">Fcommunity</p>
        </div>
        <div className=" pt-10">
            ...
            <div className=" flex space-x-3">
                <button className=" flex items-center space-x-1 px-4 border py-[6px] w-1/2 justify-center rounded-md">
                    <img alt="metamask" className=" h-5 w-5" src="//heathmont.imgix.net/bitcasino/images/metamask.svg?auto=compress,format" loading="lazy" />
                        <span>Metamask</span>
                </button>
                <button className=" flex items-center space-x-1 px-4 border py-[6px] w-1/2 justify-center rounded-md">
      ...
      <div className=" registerbanner hidden  lg:flex xl:col-span-4">
            ...
            <div>
                <p className=" text-5xl font-black text-gray-100">Welcome </p>
                <div className="">
