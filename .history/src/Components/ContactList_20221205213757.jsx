...
function ContactList() {
  ...
  const ContactArray = [ { name : "Arfat" , img : `https://pps.whatsapp.net/v/t61.24694-24/312280018_169906322326594_541453286877171405_n.jpg?ccb=11-4&oh=01_AdQ1yNbSZqdVKcnMgMRJIHB1Ir-EPaz0J7QmOLxRvme0eg&oe=639896B0`} ,{ name : "Arfat" , img : `https://pps.whatsapp.net/v/t61.24694-24/312280018_169906322326594_541453286877171405_n.jpg?ccb=11-4&oh=01_AdQ1yNbSZqdVKcnMgMRJIHB1Ir-EPaz0J7QmOLxRvme0eg&oe=639896B0`},
  ...
  return (
    <div className=' bg-slate-800'>
      ...
      <div className='mt-4'>
        {
          ContactArray.map((item,index,arrayItself) => <ContactCard key={index} showName={item.name} showImg={item.img} /> )
        }
        ...
        <ContactCard showName={ContactArray[0].name} showImg={ContactArray[0].img} />
