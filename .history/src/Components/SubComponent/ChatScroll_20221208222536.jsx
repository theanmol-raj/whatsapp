...
function Message(props){
    const ren = props.me ? <div className=' w-full max-h-max  flex justify-end'>
            <div className=' max-w-max rounded-br-none px-4 py-2 max-h-max rounded-lg bg-slate-800 text-gray-200'>
            <p>{props.text}</p>
        </div>
