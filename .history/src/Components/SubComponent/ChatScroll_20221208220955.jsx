...
function Message(props){
    return (<div>
        {props.me ? <div className=' max-w-max rounded-br-none px-14 py-2 rounded-lg bg-slate-800 text-gray-200'>
            <p>{props.text}</p>
        </div> : <div className=' max-w-max px-2 rounded-bl-none rounded-lg bg-white text-gray-800'>
        <p>{props.text}</p>
        </div>}
    </div>)
