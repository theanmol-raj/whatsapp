...
function ChatScroll() {
  return (
    <div className=' flex flex-col h-full justify-end bg-red-500 overflow-y-scroll'>
        <div className='w-full py-16 px-8 bg-yellow-400 flex flex-col justify-end space-y-3 '>
